...
const Header = () => {
  ...
  return (
    <header className="absolute inset-x-0 top-0 z-50 max-w-[1500px] mx-auto">
      ...
      {/* Mobile menu */}
      <div className={`fixed inset-0 z-50 transition-opacity duration-300 bg-black bg-opacity-50 ${mobileMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}></div>
      <div
        className={`fixed inset-y-0 right-0 z-50 w-full max-w-sm overflow-y-auto bg-white px-6 py-6 transition-transform duration-300 ease-in-out transform ${
